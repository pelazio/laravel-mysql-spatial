...
class MultiPolygonTest extends BaseTestCase
{
    ...
    public function testInvalidArgumentExceptionAtLeastOneEntry()
    {
        $this->assertException(
            ...
            'MysqlSpatial\LaravelMysqlSpatial\Types\MultiPolygon must contain at least 1 entry'
        );
    ...
    public function testInvalidArgumentExceptionNotArrayOfPolygon()
    {
        $this->assertException(
            InvalidArgumentException::class,
            'MysqlSpatial\LaravelMysqlSpatial\Types\MultiPolygon must be a collection of MysqlSpatial\LaravelMysqlSpatial\Types\Polygon'
        );
        $multipolygon = new MultiPolygon([
            $this->getPolygon1(),
            $this->getLineString1(),
