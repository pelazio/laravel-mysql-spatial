...
use MysqlSpatial\LaravelMysqlSpatial\Types\GeometryCollection;
use MysqlSpatial\LaravelMysqlSpatial\Types\LineString;
use MysqlSpatial\LaravelMysqlSpatial\Types\MultiPoint;
use MysqlSpatial\LaravelMysqlSpatial\Types\MultiPolygon;
...
class SpatialTest extends IntegrationBaseTestCase
{
    ...
    public function testSpatialFieldsNotDefinedException()
    {
        ...
        $this->assertException(\MysqlSpatial\LaravelMysqlSpatial\Exceptions\SpatialFieldsNotDefinedException::class);
    ...
    public function testOrderBySpatialWithUnknownFunction()
    {
        ...
        $this->assertException(\MysqlSpatial\LaravelMysqlSpatial\Exceptions\UnknownSpatialFunctionException::class);
    ...
    //    $point = new Point(0, 0);
    //
    //    $linestring1 = \MysqlSpatial\LaravelMysqlSpatial\Types\LineString::fromWkt("LINESTRING(1 1, 2 2)");
    //    $linestring2 = \MysqlSpatial\LaravelMysqlSpatial\Types\LineString::fromWkt("LINESTRING(20 20, 24 24)");
    //    $linestring3 = \MysqlSpatial\LaravelMysqlSpatial\Types\LineString::fromWkt("LINESTRING(0 10, 10 10)");
    //
